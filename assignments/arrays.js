...
console.log(`Car 33 is a ${inventory.find(x => x.id === 33).car_year} ${inventory.find(x => x.id === 33).car_make} ${inventory.find(x => x.id === 33).car_model}`);
...
let carModelsSorted = carModels.slice().sort();
